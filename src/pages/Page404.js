...
import { Button, Typography, Container, Box,SvgIcon,Grid,Image  } from '@mui/material';
...
export default function Page404() {
  return (
    <>
      <Helmet>
        <title> 404 Page Not Found | SNS Coding </title>
      </Helmet>
      ...
      <Container>
        <StyledContent sx={{ textAlign: 'center', alignItems: 'center' }}>
          ...
          {/* <Box
            component="img"
            src="/assets/illustrations/illustration_404 (1).svg"
      ...
      component={props => (
        ...
        >
          ...
          <image
            opacity="1"
            href="https://minimals.cc/assets/illustrations/characters/character_6.png"
            height="300"
            x="205"
            y="30"
          />
          ...
          <defs>
            ...
            >
              <stop stopColor="#76B0F1" />
              <stop offset="1" stopColor="#103996" />
            </linearGradient>
          </defs>
        </svg>
      )}
    />
          ...
          <Button marginTop="2rem" to="/dashboard/app" size="large" variant="contained" component={RouterLink}>
            Go to Home
          </Button>
        </StyledContent>
      </Container>
